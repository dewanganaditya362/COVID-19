...
const chng_country_btn = document.querySelector(".country-change");
...
chng_country_btn.addEventListener("click",function(){
...
input.addEventListener("input",function(){
    ...
    country_list.forEach(country =>{
        ...
        if(country.name.toUpperCase().startsWith(val))
            {
